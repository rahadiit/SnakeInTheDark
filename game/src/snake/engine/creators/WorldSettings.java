...
public class WorldSettings {
	...
	private static float VSCREEN_X_PORC = -.045f, VSCREEN_Y_PORC = 0.05f; // Starting point of Virtual Screen (if set) (porcentage to Screen Size
	private static float VSCREEN_WIDTH_PORC = .943f, VSCREEN_HEIGHT_PORC = .943f; //Size of Virtual Screen (porcentage to Screen Size)
