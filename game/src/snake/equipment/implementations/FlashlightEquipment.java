...
public class FlashlightEquipment extends AbstractEquipment 
{
	...
	// DESENHA NO MAPA -> ELE FAZ ISSO SOZINHO FORA COM A SPRITE QUE � GUARDADA AQUI
	...
	// FAZ PARTE DA ATUALIZA��O DA L�GICA DO JOGO -- SE N�O TEM LUZ 
	public void act (float delta) 
	{
		light.setPosition(getOriginX() + getX() + 4, getOriginY() + getY() + 3);
		light.setDirection(sprite.getRotation() + 45); // atualiza de acordo com a rota��o da imagem do objeto
		...
		// transforma�ao de coordenadas para mexer junto com o player quando for junto com o player
